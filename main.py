...
# df_final = pd.concat([pd.read_csv("5222_real_feature.csv"), pd.read_csv("5222_fake_feature.csv")])
...
# clf = xgb.XGBClassifier(booster='gbtree', learning_rate=0.2, max_depth=6, n_estimators=50, num_class=2, objective='multi:softmax', random_state=1, silent=True, subsample=0.7, n_jobs=40)
